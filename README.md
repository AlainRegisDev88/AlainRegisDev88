...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=AlainRegisDev88&layout=compact&theme=tokyonight&hide_border=true&cache_seconds=86400)
...
|-------|--------------|--------|
| **Community Intern** | Codetopia Community | 2026 |
| **Data Science & Analytics Intern** | Future Interns | May–June 2026 |
| **Co-Leader** | Youths For Change @ Ashesi | 2025–Present |
| **Founder & CMO** | Annotate | 2025–Present |
| **MasterCard Foundation Scholar** | Ashesi University | 2024–2028 |
...
- 🐍 Python for ML/Data Science (Scikit-learn, TensorFlow)
- 🚀 Full-stack web development (Express.js, Django)
...
### 1. **Annotate** — Research Workspace
*JavaScript, React, Node.js, MySQL*

Building a comprehensive research tool that helps students and researchers:
- 📌 Capture and annotate web content
...
Predictive analytics project analyzing customer behavior:
...
Developed and delivered digital literacy curriculum:
- 📱 Tech fundamentals
- 💻 Online safety
- 📧 Productivity tools
...
I occasionally share learnings on:
- 🎓 Career development & tech journey
...
- 🚜 Rural communities facing agricultural challenges
- 🌦️ Climate unpredictability affecting crop yields
- 📱 Mobile-first solutions for connectivity constraints
- 🤝 Community-driven approach to tech

### Long-term Vision
Create **ML-powered tools for smallholder farmers:**
- 🍃 Crop disease detection using computer vision
- 🌧️ Weather prediction & climate adaptation
...
- 🚀 **Building tech solutions** for underserved communities
- 📊 **Data science & ML** applications in agriculture
- 🌍 **African tech ecosystem** & startup culture
- 👥 **Community leadership** & digital skills education
...
- [ ] 📊 Build 2-3 ML/data projects with real datasets
- [ ] 💼 Land internship/freelance role in tech
- [ ] 👥 Expand Youths For Change community impact
...
### "Building technical solutions to African and global problems using data science and ML, fueled by passion for learning and helping others."

**Last updated:** June 2026 | Always learning 🌱
